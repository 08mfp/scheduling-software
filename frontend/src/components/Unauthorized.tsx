...
const Unauthorized: React.FC = () => {
  return (
    <div className="min-h-screen flex items-start justify-center bg-gray-100 px-4 p-12">
      <div className="max-w-xl w-full bg-white shadow-2xl rounded-lg p-12 text-center">
        ...
        <ul className="text-left text-gray-600 list-disc list-inside mb-8 space-y-2">
        ...
        <Link to="/" className="inline-block mb-6">
          <button className="px-8 py-3 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 text-lg">
            Go to Home
          </button>
        </Link>
        ...
        <p className="mt-4 text-sm text-gray-500">
          ...
          <Link to="/contact" className="underline text-blue-600 hover:text-blue-700">
            contact an administrator [NEED TO IMPLEMENT A CONTACT PAGE]
          </Link>.
        </p>
      </div>
    </div>
